...
// remark-gfm currently crashes on some stored transcript markdown in Wails.
// Keep the stock assistant-ui markdown renderer, but avoid the GFM plugin until
// we can sanitize/guard individual transcript messages.
